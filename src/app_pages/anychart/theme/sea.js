...
export default {
    ...
    defaultSeparator: { fill: "#9e9e9e 0.4" },
    defaultTooltip: {
        title: { fontColor: "#616161" },
        fontColor: "#757575",
        fontSize: 12,
        background: { fill: "#edeae6 0.9", stroke: "1.5 #dedbd8", corners: 5 },
        separator: { margin: { top: 10, right: 0, bottom: 10, left: 0 } },
    ...
    chart: {
        ...
        defaultSeriesSettings: {
            ...
            ohlc: {
                normal: { risingStroke: "#54dbdf", fallingStroke: "#207fbf" },
                hovered: { risingStroke: b, fallingStroke: b },
                selected: { risingStroke: "3 #54dbdf", fallingStroke: "3 #207fbf" }
            }
        },
    ...
    map: {
        unboundRegions: { enabled: !0, fill: "#e9e6e3", stroke: "#dcd8d4" },
        defaultSeriesSettings: {
            base: {
            ...
            connector: {
                normal: {
                    stroke: "1.5 #207fbf",
                    markers: { stroke: "1.5 #e9e6e3", fill: "#15a9c7" }
                },
                hovered: { stroke: "1.5 #37474f", markers: { fill: "#15a9c7" } },
    ...
    sparkline: {
        ...
        defaultSeriesSettings: {
            area: { stroke: "1.5 #54dbdf", fill: "#54dbdf 0.5" },
            column: { fill: "#54dbdf", negativeFill: "#207fbf" },
            line: { stroke: "1.5 #54dbdf" },
            winLoss: { fill: "#54dbdf", negativeFill: "#207fbf" }
        }
    },
    bullet: {
        background: { stroke: "#f7f5f3" },
        defaultMarkerSettings: { fill: "#54dbdf", stroke: "2 #54dbdf" },
    ...
    heatMap: {
        normal: { stroke: "1 #f7f5f3", labels: { fontColor: "#212121" } },
        hovered: { stroke: "1.5 #f7f5f3" },
        selected: { stroke: "2 #f7f5f3" }
    },
    treeMap: {
        normal: {
            headers: {
                background: { enabled: !0, fill: "#e9e6e3", stroke: "#dcd8d4" }
            },
    ...
    stock: {
        padding: [20, 30, 20, 60],
        defaultPlotSettings: {
            xAxis: { background: { fill: "#e9e6e3 0.5", stroke: "#dcd8d4" } }
        },
        scroller: {
            fill: "none",
