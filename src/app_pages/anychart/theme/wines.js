...
export default {
    ...
    defaultFontSettings: { fontColor: "#3e2723" },
    defaultBackground: {
        fill: {
    ...
    defaultSeparator: { fill: "#CECECE" },
    defaultTooltip: {
        background: { fill: "#e3e3e3", stroke: "#d4d4d4" },
    ...
    chart: {
        ...
        defaultSeriesSettings: {
            ...
            ohlc: {
                normal: { risingStroke: "#6f3448", fallingStroke: "#f1a122" },
                hovered: { risingStroke: b, fallingStroke: b },
                selected: { risingStroke: "3 #6f3448", fallingStroke: "3 #f1a122" }
            }
        }
    },
    map: {
        unboundRegions: { enabled: !0, fill: "#e3e3e3", stroke: "#bdbdbd" },
        defaultSeriesSettings: {
            base: { normal: { stroke: b, labels: { fontColor: "#212121" } } },
            connector: {
                normal: {
                    stroke: "1.5 #6f3448",
                    markers: { stroke: "1.5 #e3e3e3", fill: "#857600" }
                },
                hovered: { stroke: "1.5 #37474f", markers: { fill: "#857600" } },
    ...
    sparkline: {
        ...
        defaultSeriesSettings: {
            area: { stroke: "1.5 #6f3448", fill: "#6f3448 0.5" },
            column: { fill: "#6f3448", negativeFill: "#f1a122" },
            line: { stroke: "1.5 #6f3448" },
            winLoss: { fill: "#6f3448", negativeFill: "#f1a122" }
        }
    },
    bullet: {
        background: { stroke: "#e3e3e3" },
        defaultMarkerSettings: { fill: "#6f3448", stroke: "2 #6f3448" },
    ...
    heatMap: {
        normal: { stroke: "1 #e3e3e3", labels: { fontColor: "#212121" } },
        hovered: { stroke: "1.5 #e3e3e3" },
        selected: { stroke: "2 #e3e3e3" }
    },
    treeMap: {
        normal: {
            headers: {
