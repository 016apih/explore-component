...
export default{
    ...
    defaultGridSettings: { stroke: "#d7cacc" },
    defaultMinorGridSettings: { stroke: "#f1eaeb" },
    defaultSeparator: { fill: "#fce4ec" },
    defaultTooltip: {
        background: { fill: "#3C3C3C 0.8"/** "#fef7f9 0.9" */, stroke: "2 #fce4ec", corners: 3 },
        fontSize: 13,
    ...
    defaultColorRange: {
        stroke: "#d7cacc",
        ticks: { stroke: "#d7cacc", position: "outside", length: 7, enabled: !0 },
        minorTicks: {
            stroke: "#d7cacc",
            position: "outside",
            length: 5,
    ...
    defaultScroller: {
        ...
        thumbs: {
            fill: "#f4efef",
            stroke: "#d7cacc",
            hovered: { fill: "#d7cacc", stroke: "#beafb1" }
        }
    },
    ...
    chart: {
        defaultSeriesSettings: {
            ...
            ohlc: {
                normal: { risingStroke: "#f8bbd0", fallingStroke: "#880e4f" },
                hovered: { risingStroke: b, fallingStroke: b },
                selected: { risingStroke: "3 #f8bbd0", fallingStroke: "3 #880e4f" }
            }
        },
        title: { fontSize: 17 },
    ...
    map: {
        unboundRegions: { enabled: !0, fill: "#f4efef", stroke: "#ece1e3" },
        defaultSeriesSettings: {
            base: { normal: { stroke: b, labels: { fontColor: "#212121" } } },
            connector: {
                normal: { markers: { stroke: "1.5 #ece1e3" } },
                hovered: { markers: { stroke: "1.5 #ece1e3" } },
                selected: { markers: { stroke: "1.5 #ece1e3" } }
            }
        }
    },
    sparkline: {
    ...
    treeMap: {
        normal: {
            headers: {
                background: { enabled: !0, fill: "#f4efef", stroke: "#ece1e3" }
            },
            labels: { fontColor: "#212121" },
            stroke: "#ece1e3"
        },
        hovered: {
            headers: {
                fontColor: "#5d1b3e",
                background: { fill: "#ece1e3", stroke: "#ece1e3" }
            }
        },
    ...
    stock: {
        padding: [20, 30, 20, 60],
        defaultPlotSettings: {
            xAxis: { background: { fill: "#d7cacc 0.3", stroke: "#d7cacc" } }
        },
        scroller: {
            fill: "none",
